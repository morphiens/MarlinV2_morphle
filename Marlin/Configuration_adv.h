...
#define X_BUMP              1
#define Y_BUMP              1
#define Z_BUMP              1/(Z_LEVER_REDUCTION*0.9)                           // This is to convert lever reduction in Z axis
#define SENSOR_HALFWAY      2.5
#define HOMING_X_BUMP       9.62-SENSOR_HALFWAY                                 // This is the distance the blocker is allowed physically to go in 
#define HOMING_Y_BUMP       4.74-SENSOR_HALFWAY
#define HOMING_Z_BUMP       (8.80-SENSOR_HALFWAY)/(Z_LEVER_REDUCTION*0.9)
